...
# Challenge 1B Setup Script
# This script sets up the necessary directory structure for the project
...
echo "2. Run: docker run --rm -v \$(pwd)/input:/app/input -v \$(pwd)/output:/app/output --network none challenge1b:latest 'your_input.json' 'your_output.json'" 